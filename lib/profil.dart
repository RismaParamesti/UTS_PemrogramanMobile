...
class AdditionalCardDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, String>> additionalCardDetails = [
      ...
      },
      {
        ...
        'awards':
            '1st Winner Madrasah Science Competition in Integrated Physics Belitung Regency Level. (2022), 6th WinnerMadrasah Science Competition in Integrated Physics Provincial Level of Bangka Belitung Islands. (2022), 4th Winner of Wonderful Sail Indonesia Kelayang Beach Painting Competition. (2022) , 1st Winner anniversary poster competition of Madrasah Aliyah 1 Belitung. (2022) , Awardee S1 LPDP Dalam Negeri. (2022-now) , 2nd Winner Mind Mapping Competition AMN Surabaya National Tour. (2023)'
      }
    ];
      ...
      body: Container(
        decoration: BoxDecoration(
          color: Color.fromARGB(
              255, 255, 255, 255), // Ubah warna latar belakang sesuai keinginan
        ),
        child: Center(
          child: Column(
  ...
  Widget _buildDetailItemCard(String title, String value,
      {bool isLink = false}) {
    return Card(
