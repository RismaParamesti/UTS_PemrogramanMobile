                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          _buildKetuaProgramStudiInfo('Nama',
                                              prodi.ketuaProgramStudi.nama),
                                          _buildKetuaProgramStudiInfo('NIP',
                                              prodi.ketuaProgramStudi.NIP),
                                          _buildKetuaProgramStudiInfo('Email',
                                              prodi.ketuaProgramStudi.email),
                                          _buildKetuaProgramStudiInfo(
                                              'Keahlian',
                                              prodi.ketuaProgramStudi.keahlian),
                                        ],
                                      ),
                                    ),
                                  ),
